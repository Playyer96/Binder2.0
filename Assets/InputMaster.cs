...
//     version 1.11.1
//     from Packages/com.yolo.ability-system/Inputs/InputMaster.inputactions
//
...
public partial class @InputMaster: IInputActionCollection2, IDisposable
{
    ...
    ~@InputMaster()
    {
        UnityEngine.Debug.Assert(!m_AbilitySystem.enabled, "This will cause a leak and performance issues, InputMaster.AbilitySystem.Disable() has not been called.");
    }
    ...
    private List<IAbilitySystemActions> m_AbilitySystemActionsCallbackInterfaces = new List<IAbilitySystemActions>();
    ...
    public struct AbilitySystemActions
    {
        ...
        public void AddCallbacks(IAbilitySystemActions instance)
        {
            if (instance == null || m_Wrapper.m_AbilitySystemActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_AbilitySystemActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IAbilitySystemActions instance)
        {
            @FirstAbility.started -= instance.OnFirstAbility;
            @FirstAbility.performed -= instance.OnFirstAbility;
            @FirstAbility.canceled -= instance.OnFirstAbility;
        ...
        public void RemoveCallbacks(IAbilitySystemActions instance)
        {
            if (m_Wrapper.m_AbilitySystemActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IAbilitySystemActions instance)
        {
            foreach (var item in m_Wrapper.m_AbilitySystemActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_AbilitySystemActionsCallbackInterfaces.Clear();
